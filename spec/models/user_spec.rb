...
RSpec.describe User, type: :model do
  describe '#create' do
    ...
    it 'nameとemail、passwordとpassword_confirmation、profile、occupation、positionが存在すれば登録できること' do
    ...
    it 'emailに@マークが含まれる場合は登録できること' do
      @user.email = 'test@test.com'
      expect(@user).to be_valid
    end

    it 'emailに@マークが含まれない場合は登録できないこと' do
      @user.email = 'test.com'
      @user.valid?
